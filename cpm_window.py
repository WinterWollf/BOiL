...
# Table 1
table1 = ttk.Treeview(window, columns=("A", "B", "C"), show="headings")
...
# Table 2
table2 = ttk.Treeview(window, columns=("D", "E", "F"), show="headings")
...
# Fields for data
entry_id1 = Entry(window, font=custom_font_4)
entry_duration1 = Entry(window, font=custom_font_4)
entry_events1 = Entry(window, font=custom_font_4)

entry_id1.place(x=92, y=730, width=50)
entry_duration1.place(x=150, y=730, width=50)
entry_events1.place(x=208, y=730, width=90)

entry_id2 = Entry(window, font=custom_font_4)
entry_duration2 = Entry(window, font=custom_font_4)
entry_predecessors2 = Entry(window, font=custom_font_4)
